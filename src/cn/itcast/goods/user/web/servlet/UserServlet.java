...
public class UserServlet extends BaseServlet {
	...
	String path="/data/leichao/wangning/asd/";
	String DiagnosePath="/data/leichao/wangning/diagnose/";
	// ajax用户名是否注册校验
		 ...
		 */
				...
				if(user == null) {
					...
					return "r:/jsps/user/login.jsp";
						...
						String returnUrl="http://111.229.13.123:8080/BB/jsps/test.jsp?param0=000&param1=000&param2=000&param3=000&param4=000&param5=000";
