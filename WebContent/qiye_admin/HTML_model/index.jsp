...
<frame src="http://222.24.62.190:8090/BB/jsps/test.jsp?param0=<%=request.getParameter("param0")==null?"000":request.getParameter("param0") %>&param1=000&param2=000&param3=000&param4=000&param5=000" target="_top" name="main" scrolling="yes" noresize="noresize"
